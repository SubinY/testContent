...
function buildProjectionVariant(topic: string): TestVariant {
  ...
  return {
    ...
    rawModelOutput: "[local-mode mock] image_projection template",
...
function buildStoryVariant(topic: string): TestVariant {
  ...
  return {
    ...
    textProvider: "local",
    textModel: "mock-template",
    rawModelOutput: "[local-mode mock] story_scene template",
...
function buildAttachmentVariant(topic: string): TestVariant {
  ...
  return {
    ...
    textProvider: "local",
    textModel: "mock-template",
    rawModelOutput: "[local-mode mock] attachment_index template",
...
function buildPotentialVariant(topic: string): TestVariant {
  ...
  return {
    ...
    textProvider: "local",
    textModel: "mock-template",
    rawModelOutput: "[local-mode mock] life_potential template",
...
function buildMentalHealthVariant(topic: string): TestVariant {
  ...
  return {
    ...
    textProvider: "local",
    textModel: "mock-template",
    rawModelOutput: "[local-mode mock] mental_health_check template",
